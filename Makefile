...
fetchDep:
	...
	go get -d github.com/adamin1990/AndroidLibV2rayLite
...
export PATH
downloadGoMobile:
	cd ~ ;curl -L https://raw.githubusercontent.com/adamin1990/AndroidLibV2rayLite/master/ubuntu-cli-install-android-sdk.sh | sudo bash -
	ls ~
	ls ~/android-sdk-linux/

BuildMobile:
	gomobile init
	gomobile bind -androidapi 19 -v -ldflags='-s -w' github.com/adamin1990/AndroidLibV2rayLite
